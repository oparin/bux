 ...
 *
 * @ORM\Entity
 * @ORM\Table(name="bux_advertise_banner_ads")
 */
class BannerAd
{
    /**
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Bux\UserBundle\Entity\User", inversedBy="bannerAds")
    ...
    /**
     * @ORM\ManyToMany(targetEntity="Bux\AdvertiseBundle\Entity\Country", inversedBy="bannerAds")
     * @ORM\JoinTable(name="banner_ads_country")
     **/
    protected $countries;

    /**
     * @ORM\ManyToMany(targetEntity="Bux\UserBundle\Entity\Membership", inversedBy="bannerAds")
     * @ORM\JoinTable(name="banner_ads_memberships")
     **/

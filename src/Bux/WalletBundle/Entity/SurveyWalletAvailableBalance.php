...
/**
 * Class SurveyWalletAvailableBalance
 *
 * @package Bux\WalletBundle\Entity
 *
 * @ORM\Entity
 * @ORM\Table(name="bux_survey_wallet_available_balance")
 */
class SurveyWalletAvailableBalance
{
    /**
    ...
    /**
     * @ORM\OneToOne(targetEntity="Bux\UserBundle\Entity\User", inversedBy="surveyWalletAvailableBalance")
     ...
     * @param string $sum
     *
     * @return SurveyWalletAvailableBalance
     */
